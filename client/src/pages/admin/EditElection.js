  ...
  if (error && !election) {
    return (
      <div className="min-h-screen flex justify-center items-center flex-col">
        ...
        <button onClick={() => navigate("/admin/elections")} className="text-primary-600 hover:text-primary-700">
            ...
            {({ values, errors, touched, isSubmitting }) => (
              <Form className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-200">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Manage the positions for this election</p>
                </div>
                        ...
                        values.positions.map((position, index) => (
                          <div key={index} className="mb-4 p-4 border rounded-md">
                            ...
                            <div className="space-y-4">
                              <Field type="hidden" name={`positions.${index}._id`} />
